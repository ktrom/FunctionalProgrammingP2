...
public class VarLangParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, Define=7, Let=8, Lete=9, 
		Dec=10, Dot=11, Number=12, Identifier=13, Letter=14, LetterOrDigit=15, 
	...
	private static final String[] _LITERAL_NAMES = {
		null, "'('", "')'", "'-'", "'+'", "'*'", "'/'", "'define'", "'let'", "'lete'", 
		"'dec'", "'.'", null, null, null, null, "'@'", "'...'"
	};
	private static final String[] _SYMBOLIC_NAMES = {
		null, null, null, null, null, null, null, "Define", "Let", "Lete", "Dec", 
	...
	public final ExpContext exp() throws RecognitionException {
		...
		try {
			...
			case 9:
				...
				{
				setState(46);
				((ExpContext)_localctx).dc = decexp();
				((ExpContext)_localctx).ast =  ((ExpContext)_localctx).dc.ast; 
				}
				break;
			}
		}
	...
	public final LeteexpContext leteexp() throws RecognitionException {
		...
		try {
			...
			match(Lete);
			setState(74);
			((LeteexpContext)_localctx).k = exp();
			setState(75);
			match(T__0);
			setState(82); 
			_errHandler.sync(this);
			...
			setState(88);
			match(T__1);
			 ((LeteexpContext)_localctx).ast =  new LeteExp(((LeteexpContext)_localctx).k.ast, _localctx.names, _localctx.value_exps, ((LeteexpContext)_localctx).body.ast); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DecexpContext decexp() throws RecognitionException {
		...
		try {
			...
			match(Dec);
			setState(93);
			((DecexpContext)_localctx).k = exp();
			setState(94);
			((DecexpContext)_localctx).e = exp();
			setState(95);
			match(T__1);
			 ((DecexpContext)_localctx).ast =  new DecExp(((DecexpContext)_localctx).k.ast, ((DecexpContext)_localctx).e.ast); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static final String _serializedATN =
		...
		"F\7\4\2\2FG\5\2\2\2GH\7\4\2\2HI\b\4\1\2I\7\3\2\2\2JK\7\3\2\2KL\7\13\2"+
		"\2LM\5\2\2\2MT\7\3\2\2NO\7\3\2\2OP\7\17\2\2PQ\5\2\2\2QR\7\4\2\2RS\b\5"+
		"\1\2SU\3\2\2\2TN\3\2\2\2UV\3\2\2\2VT\3\2\2\2VW\3\2\2\2WX\3\2\2\2XY\7\4"+
		"\2\2YZ\5\2\2\2Z[\7\4\2\2[\\\b\5\1\2\\\t\3\2\2\2]^\7\3\2\2^_\7\f\2\2_`"+
		"\5\2\2\2`a\5\2\2\2ab\7\4\2\2bc\b\6\1\2c\13\3\2\2\2de\5\2\2\2ef\b\7\1\2"+
		"f\r\3\2\2\2gh\7\16\2\2hv\b\b\1\2ij\7\5\2\2jk\7\16\2\2kv\b\b\1\2lm\7\16"+
		"\2\2mn\7\r\2\2no\7\16\2\2ov\b\b\1\2pq\7\5\2\2qr\7\16\2\2rs\7\r\2\2st\7"+
		"\16\2\2tv\b\b\1\2ug\3\2\2\2ui\3\2\2\2ul\3\2\2\2up\3\2\2\2v\17\3\2\2\2"+
		"wx\7\3\2\2xy\7\6\2\2yz\5\2\2\2z~\b\t\1\2{|\5\2\2\2|}\b\t\1\2}\177\3\2"+
		"\2\2~{\3\2\2\2\177\u0080\3\2\2\2\u0080~\3\2\2\2\u0080\u0081\3\2\2\2\u0081"+
		"\u0082\3\2\2\2\u0082\u0083\7\4\2\2\u0083\u0084\b\t\1\2\u0084\21\3\2\2"+
		"\2\u0085\u0086\7\3\2\2\u0086\u0087\7\5\2\2\u0087\u0088\5\2\2\2\u0088\u008c"+
		"\b\n\1\2\u0089\u008a\5\2\2\2\u008a\u008b\b\n\1\2\u008b\u008d\3\2\2\2\u008c"+
		"\u0089\3\2\2\2\u008d\u008e\3\2\2\2\u008e\u008c\3\2\2\2\u008e\u008f\3\2"+
		"\2\2\u008f\u0090\3\2\2\2\u0090\u0091\7\4\2\2\u0091\u0092\b\n\1\2\u0092"+
		"\23\3\2\2\2\u0093\u0094\7\3\2\2\u0094\u0095\7\7\2\2\u0095\u0096\5\2\2"+
